...
Figure \ref{fig:cntpltA} shows the results when $K=0$, the standard approach
 for computing the decision rule.  The error bound, 0.0112529 is 25\% larger than the actual error 0.00912752.

\begin{figure}
  \centering
  \includegraphics{resDir/forBetterRBC--1,1,1-Iters20theK0numKern16.pdf}
...
\begin{figure}
  \centering
  \includegraphics{resDir/forBetterRBC--1,1,1-Iters30theK10numKern16.pdf}
  \caption{Contour Plot for approx=(1,1,1) K =10}
  \label{fig:cntplt}
\end{figure}

\begin{figure}
  \centering
  \includegraphics{resDir/forBetterRBC--2,2,2-Iters2theK2numKern5.pdf}
  \caption{Contour Plot for approx=(2,2,2) 2 iterations and K =2}
  \label{fig:cntplt}
\end{figure}

\begin{figure}
  \centering
  \includegraphics{resDir/forBetterRBC--2,2,2-Iters5theK5numKern5.pdf}
  \caption{Contour Plot for approx=(2,2,2) 5 iterations and K =5}
  \label{fig:cntplt}
\end{figure}

\begin{figure}
  \centering
  \includegraphics{resDir/forBetterRBC--2,2,1-Iters4theK10numKern5.pdf}
  \caption{Contour Plot for approx=(2,2,2) 5 iterations and K =5}
  \label{fig:cntplt}
\end{figure}
