...
\marginpar{homoiconic, julia. not necessarily need all symbolic, strike balance maybe all numeric}
...
\marginpar{function names bold. parallel works for traditional too.}
...
\begin{figure}
  ...
  \label{fig:erg}
\end{figure}
\marginpar{correct caption for ergodic values transformed}

\marginpar{show solution accuracy simple and OBC}

\marginpar{revise assess error calc or eliminate}

\marginpar{revise assess robust or eliminate}
