...
\item[$\smolSpec$] Smolyak anisotropic grid polynomials $(\aSmolPoly{1},\ldots,\aSmolPoly{N})$ and their conditional expectations $(\aSmolPolyCE{1},\ldots,\aSmolPolyCE{N})$
...
\tcc{Solves model equations at collocation points producing interpolation data returns the  
...
\caption{$makeInterpFunc$} 
\label{makeInterpFunc}
\end{algorithm}
