...
\begin{abstract}
  This paper proposes a new series representation for bounded discrete time series paths an uses it to construct   construct error bounds for proposed solutions for a very broad class of dynamic stochastic models.
...
\includegraphics{resDir/forBetterRBC--1,1,1-Iters20theK0numKern16Approx.pdf}
\fi
  \caption{Contour Plot for traditional approx=(1,1,1) K =0 (Standard Approach)}
  \label{fig:cntpltA}
\end{figure}
