...
The values for the z's are not at all important 
and their relationship to the x trajectories are rather unintuitive. What is important is that these values exist and are easy to compute.
...
\item More information about other error formulae.
\item multiple formulae?
...
\item Proof for robustness and accuracy and parallelism gains.
\item doPrepPoly
