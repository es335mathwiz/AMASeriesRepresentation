...
We can assess the impact of incorrect values for $z+t$ by computing the maximum correction required for the $z_t$ and applying the 
same formula.
...
\label{sec:extToMaps}
\begin{itemize}
\item Simple single equation system
\item later will need to introduce collection of equation systems with  boolean gates
