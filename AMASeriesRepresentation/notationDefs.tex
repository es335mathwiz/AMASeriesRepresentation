...
\newglossaryentry{zVars}{name=\ensuremath{{z}},sort={az},
  description={ use \chkShow{\zVars}   The unconditional z variables characterizing the discrepancy between the model equations and the current unconditional expectations path.}}
  \newcommand{\zVars}{{\gls{zVars}}}


  \newglossaryentry{ZVars}{name=\ensuremath{{Z}},sort={aZ},
  description={ use \chkShow{\ZVars}   The unconditional Z variables characteriZing the discrepancy between the model equations and the current conditional expectations path.}}
  \newcommand{\ZVars}{{\gls{ZVars}}}
