...
\begin{itemize}
\item \href{https://people.eecs.berkeley.edu/~tommasodreossi/papers/phd_thesis.pdf}{reachability}
\end{itemize}


\labday{Friday September 28, 2018}

\begin{itemize}
\item tar -cvf allfiles.tar \$(cat mylist.txt)
\end{itemize}
